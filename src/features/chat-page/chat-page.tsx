...
export const ChatPage: FC<ChatPageProps> = (props) => {
  ...
  return (
    <main className="flex flex-1 relative flex-col bg-gradient-to-b from-white dark:from-[#061826] to-[#F0F0F0]/50 dark:to-[#0A234B]/50 transition-colors duration-200">
      <ChatHeader
        chatThread={props.chatThread}
